...
{
       0,   111,   111,   116,   118,   120,   127,   133,   140,   141,
     146,   148,   150,   155,   156,   158,   163,   169,   170,   172,
     177,   179,   181,   185,   187,   189,   191,   193,   196,   198,
     200,   203,   206,   209,   212,   214,   217,   220,   223,   225,
...
#line 134 "cool.bison"
  { (yyval.class_) = class_((yyvsp[-6].symbol), idtable.add_string((yyvsp[-4].symbol)->get_string()), (yyvsp[-2].features), stringtable.add_string(curr_filename)); }
