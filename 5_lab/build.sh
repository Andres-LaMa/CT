...
CXXFLAGS="-Wall -I ./src/ -Wno-unused -Wno-deprecated  -Wno-write-strings -Wno-free-nonheap-object -g3"
...
g++ $LDFLAGS $CXXFLAGS parser-phase.o utilities.o stringtab.o cool-tree.o cool-flex-lexer.o cool-bison-parser.o semant.o -o parser
