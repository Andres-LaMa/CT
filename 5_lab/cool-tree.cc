...
// {
//    // Проверяем, что тип возвращаемого значения существует
...
//    // Входим в новую область видимости для формальных параметров
//    attribtable.enterscope();
//    std::set<Symbol> used_names;

//    // Проверяем формальные параметры
//    for (int i = formals->first(); formals->more(i); i = formals->next(i))
//    {
...
//    // if (!classtable->IsParent(return_type, expr_type))
//    // {
//    //    classtable->semant_error(curr_class)
...
// void method_class::AddMethodToTable(Symbol class_name) { /* реализация */ }
// void method_class::AddAttribToTable(Symbol class_name) { /* реализация */ }

// void attr_class::CheckFeatureType() { /* реализация */ }
// void attr_class::AddMethodToTable(Symbol class_name) { /* реализация */ }
// void attr_class::AddAttribToTable(Symbol class_name) { /* реализация */ }

// //////////////////////////////////////////

// Symbol object_class::CheckExprType() { /* реализация */ }
// Symbol no_expr_class::CheckExprType() { /* реализация */ }
// Symbol isvoid_class::CheckExprType() { /* реализация */ }
// Symbol new__class::CheckExprType() { /* реализация */ }
// Symbol string_const_class::CheckExprType() { /* реализация */ }
// Symbol bool_const_class::CheckExprType() { /* реализация */ }
// Symbol int_const_class::CheckExprType() { /* реализация */ }
// Symbol comp_class::CheckExprType() { /* реализация */ }
// Symbol leq_class::CheckExprType() { /* реализация */ }
// Symbol eq_class::CheckExprType() { /* реализация */ }
// Symbol lt_class::CheckExprType() { /* реализация */ }
// Symbol neg_class::CheckExprType() { /* реализация */ }
// Symbol divide_class::CheckExprType() { /* реализация */ }
// Symbol mul_class::CheckExprType() { /* реализация */ }
// Symbol sub_class::CheckExprType() { /* реализация */ }
// Symbol plus_class::CheckExprType() { /* реализация */ }
// Symbol let_class::CheckExprType() { /* реализация */ }
// Symbol block_class::CheckExprType() { /* реализация */ }
// Symbol typcase_class::CheckExprType() { /* реализация */ }
// Symbol loop_class::CheckExprType() { /* реализация */ }
// Symbol cond_class::CheckExprType() { /* реализация */ }
// Symbol dispatch_class::CheckExprType() { /* реализация */ }
// Symbol static_dispatch_class::CheckExprType() { /* реализация */ }
// Symbol assign_class::CheckExprType() { /* реализация */ }

// /////////////////////////////////////////////////////

// Symbol branch_class::CheckBranchType() { /* реализация */ }
